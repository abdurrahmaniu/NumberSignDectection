...
import os
import glob
if os.path.isdir('C:/Users/helium/Desktop/NumberSignGestureRecognition-master/data/train')==False:
    os.mkdir('data')
    os.mkdir('data/train')
    os.mkdir('data/test')
dir=input('Enter which data do you want to collect(test/train) : ')
if os.path.isdir(r'C:/Users/helium/Desktop/NumberSignGestureRecognition-master/data/'+dir)==False:
    os.mkdir('data/'+dir)
